...
- `[Datagrid]` Fixed the memory leak on the detached HTML elements and sped up scrolling down for a single page setting. ([#8833](https://github.com/infor-design/enterprise/issues/8833))
## v4.96.0
